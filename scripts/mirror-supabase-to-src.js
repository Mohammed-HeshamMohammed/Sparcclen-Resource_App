// Mirror the root `supabase/` folder into `src/supabase/`.
// Usage: node scripts/mirror-supabase-to-src.js
...
(async () => {
  try {
    ...
    const fromDir = path.resolve(root, 'supabase');
    const toDir = path.resolve(root, 'src', 'supabase');

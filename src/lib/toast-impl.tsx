...
notify.success = (message: string, opts: Partial<ToastProps> = {}) =>
  notify({ message, variant: 'success', ...opts })
notify.error = (message: string, opts: Partial<ToastProps> = {}) =>
  notify({ message, variant: 'error', ...opts })
notify.warning = (message: string, opts: Partial<ToastProps> = {}) =>
  notify({ message, variant: 'warning', ...opts })
notify.info = (message: string, opts: Partial<ToastProps> = {}) =>
  notify({ message, variant: 'default', ...opts })

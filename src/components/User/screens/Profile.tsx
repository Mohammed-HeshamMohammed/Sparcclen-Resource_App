...
export function Profile() {
  ...
  useEffect(() => {
    // Update display from user or save depending on mode
    if (user) {
    ...
    if (offlineActive) {
      const dn = (save?.displayName && save.displayName.trim()) || 'offline user';
      setDisplayName(dn);
      setEmail(save?.lastEmail || null);
    }
  }, [user, save, isOnline]);
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="space-y-4">
                ...
                <div>
                  ...
                  <p className="text-gray-900 dark:text-white">{email ?? (save?.offlineSession ? "Email unavailable in offline mode" : 'Unknown')}</p>
                </div>
              ...
              <div className="space-y-4">
                ...
                <div>
                  ...
                  <p className="text-gray-900 dark:text-white">{user ? '0' : (save?.offlineSession ? 'Countless (in your imagination)' : '0')}</p>
                </div>
